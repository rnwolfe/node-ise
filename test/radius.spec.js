...
describe('RADIUS Policy Sets:', () => {
  describe('Get policy sets:', () => {
    it('should get all policy sets', async () => {
      const policySets = await ise.getRadiusPolicySets();
      ...
      // Disabling to increase consistency of test; type checking was overkill.
    ...
    it('should get a policy set by name', async () => {
      const policySet = await ise.getRadiusPolicySetByName('Default');
  ...
  describe("Get a policy set's details:", () => {
    it('should resolve all policy objects', async () => {
      const policySet = await ise.getRadiusPolicySetByName('Default');
      const policy = await ise.resolveRadiusPolicySet(policySet.id);
