...
PATHS.RADIUS_AUTHENTICATION_POLICY = id => PATHS.RADIUS_POLICY_SETS + id + '/authentication/';
PATHS.RADIUS_AUTHORIZATION_POLICY = id => PATHS.RADIUS_POLICY_SETS + id + '/authorization/';
...
PATHS.RADIUS_LOCAL_EXCEPTIONS = id => PATHS.RADIUS_POLICY_SETS + id + '/exceptions';
...
PATHS.TACACS_AUTHENTICATION_POLICY = id => PATHS.TACACS_POLICY_SETS + id + '/authentication/';
PATHS.TACACS_AUTHORIZATION_POLICY = id => PATHS.TACACS_POLICY_SETS + id + '/authorization/';
...
PATHS.TACACS_LOCAL_EXCEPTIONS = id => PATHS.TACACS_POLICY_SETS + id + '/exceptions';
...
PATHS.VULNERABILITY_ENDPOINTS_OVER_TIME =
  PATHS.API + 'visibility/fetchVulnerabilityEndpointsOverTime/';
...
PATHS.TCNAC_LIVE_LOGS = 'irf/sasLiveLog';
