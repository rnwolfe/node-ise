...
const ACTIVE_ENDPOINTS_METRIC = UI_API_PATH + 'visibility/fetchMetricData/activeEndpoints';
const REJECTED_ENDPOINTS_METRIC = UI_API_PATH + 'visibility/fetchMetricData/rejectedEndpoints';
const ANOMALOUS_ENDPOINTS_METRIC = UI_API_PATH + 'visibility/fetchMetricData/anomalousEndpoints';
const AUTHENTICATED_GUEST_METRIC = UI_API_PATH + 'visibility/fetchMetricData/authenticateGuest';
const BYOD_ENDPOINTS_METRIC = UI_API_PATH + 'visibility/fetchMetricData/byodEndpoints';
const DEVICE_COMPLIANCE_METRIC = UI_API_PATH + 'visibility/fetchChartData/DeviceCompliance';
...
class ISE {
  ...
  getDeviceCompliance() {
    return this.session.get(DEVICE_COMPLIANCE_METRIC).then(response => response.data);
  }
